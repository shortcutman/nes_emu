...
nes_emu::CPU::OpCodeMap nes_emu::CPU::buildOpCodeMap(nes_emu::CPU* cpu) {
    return {
        ...
        {0xE7, {0xE7, 2, 5, "ISC", [cpu] { cpu->isc(AddressMode::ZeroPage); }}},
        {0xF7, {0xF7, 2, 6, "ISC", [cpu] { cpu->isc(AddressMode::ZeroPageX); }}},
        {0xEF, {0xEF, 3, 6, "ISC", [cpu] { cpu->isc(AddressMode::Absolute); }}},
        {0xFF, {0xFF, 3, 7, "ISC", [cpu] { cpu->isc(AddressMode::AbsoluteX); }}},
        {0xFB, {0xFB, 3, 7, "ISC", [cpu] { cpu->isc(AddressMode::AbsoluteY); }}},
        {0xE3, {0xE3, 2, 8, "ISC", [cpu] { cpu->isc(AddressMode::Indirect_X); }}},
        {0xF3, {0xF3, 2, 8, "ISC", [cpu] { cpu->isc(AddressMode::Indirect_Y); }}},
        {0x07, {0x07, 2, 5, "SLO", [cpu] { cpu->slo(AddressMode::ZeroPage); }}},
        {0x17, {0x17, 2, 6, "SLO", [cpu] { cpu->slo(AddressMode::ZeroPageX); }}},
        {0x0F, {0x0F, 3, 6, "SLO", [cpu] { cpu->slo(AddressMode::Absolute); }}},
        {0x1F, {0x1F, 3, 7, "SLO", [cpu] { cpu->slo(AddressMode::AbsoluteX); }}},
        ...
        {0xA7, {0xA7, 2, 3, "LAX", [cpu] { cpu->lax(AddressMode::ZeroPage); }}},
        {0xB7, {0xB7, 2, 4, "LAX", [cpu] { cpu->lax(AddressMode::ZeroPageY); }}},
        {0xAF, {0xAF, 3, 4, "LAX", [cpu] { cpu->lax(AddressMode::Absolute); }}},
        {0xBF, {0xBF, 3, 4, "LAX", [cpu] { cpu->lax(AddressMode::AbsoluteY); }}},
        {0xA3, {0xA3, 2, 6, "LAX", [cpu] { cpu->lax(AddressMode::Indirect_X); }}},
        {0xB3, {0xB3, 2, 5, "LAX", [cpu] { cpu->lax(AddressMode::Indirect_Y); }}},
        {0x87, {0x87, 2, 3, "AAX", [cpu] { cpu->aax(AddressMode::ZeroPage); }}},
        {0x97, {0x97, 2, 4, "AAX", [cpu] { cpu->aax(AddressMode::ZeroPageY); }}},
        {0x83, {0x83, 2, 6, "AAX", [cpu] { cpu->aax(AddressMode::Indirect_X); }}},
        {0x8F, {0x8F, 3, 4, "AAX", [cpu] { cpu->aax(AddressMode::Absolute); }}},
        {0xEB, {0xEB, 2, 2, "SBC", [cpu] { cpu->sbc(AddressMode::Immediate); }}},
        {0xC7, {0xC7, 2, 5, "DCP", [cpu] { cpu->dcp(AddressMode::ZeroPage); }}},
        {0xD7, {0xD7, 2, 6, "DCP", [cpu] { cpu->dcp(AddressMode::ZeroPageX); }}},
        {0xCF, {0xCF, 3, 6, "DCP", [cpu] { cpu->dcp(AddressMode::Absolute); }}},
        {0xDF, {0xDF, 3, 7, "DCP", [cpu] { cpu->dcp(AddressMode::AbsoluteX); }}},
        {0xDB, {0xDB, 3, 7, "DCP", [cpu] { cpu->dcp(AddressMode::AbsoluteY); }}},
        {0xC3, {0xC3, 2, 8, "DCP", [cpu] { cpu->dcp(AddressMode::Indirect_X); }}},
        {0xD3, {0xD3, 2, 8, "DCP", [cpu] { cpu->dcp(AddressMode::Indirect_Y); }}},
        {0x27, {0x27, 2, 5, "RLA", [cpu] { cpu->rla(AddressMode::ZeroPage); }}},
        {0x37, {0x37, 2, 6, "RLA", [cpu] { cpu->rla(AddressMode::ZeroPageX); }}},
        {0x2F, {0x2F, 3, 6, "RLA", [cpu] { cpu->rla(AddressMode::Absolute); }}},
        {0x3F, {0x3F, 3, 7, "RLA", [cpu] { cpu->rla(AddressMode::AbsoluteX); }}},
        {0x3B, {0x3B, 3, 7, "RLA", [cpu] { cpu->rla(AddressMode::AbsoluteY); }}},
        {0x23, {0x23, 2, 8, "RLA", [cpu] { cpu->rla(AddressMode::Indirect_X); }}},
        {0x33, {0x33, 2, 8, "RLA", [cpu] { cpu->rla(AddressMode::Indirect_Y); }}},
        {0x47, {0x47, 2, 5, "sre", [cpu] { cpu->sre(AddressMode::ZeroPage); }}},
        {0x57, {0x57, 2, 6, "sre", [cpu] { cpu->sre(AddressMode::ZeroPageX); }}},
        {0x4F, {0x4F, 3, 6, "sre", [cpu] { cpu->sre(AddressMode::Absolute); }}},
        {0x5F, {0x5F, 3, 7, "sre", [cpu] { cpu->sre(AddressMode::AbsoluteX); }}},
        {0x5B, {0x5B, 3, 7, "sre", [cpu] { cpu->sre(AddressMode::AbsoluteY); }}},
        {0x43, {0x43, 2, 8, "sre", [cpu] { cpu->sre(AddressMode::Indirect_X); }}},
        {0x53, {0x53, 2, 8, "sre", [cpu] { cpu->sre(AddressMode::Indirect_Y); }}},
        {0x67, {0x67, 2, 5, "RRA", [cpu] { cpu->rra(AddressMode::ZeroPage); }}},
        {0x77, {0x77, 2, 6, "RRA", [cpu] { cpu->rra(AddressMode::ZeroPageX); }}},
        {0x6F, {0x6F, 3, 6, "RRA", [cpu] { cpu->rra(AddressMode::Absolute); }}},
        {0x7F, {0x7F, 3, 7, "RRA", [cpu] { cpu->rra(AddressMode::AbsoluteX); }}},
        {0x7B, {0x7B, 3, 7, "RRA", [cpu] { cpu->rra(AddressMode::AbsoluteY); }}},
        {0x63, {0x63, 2, 8, "RRA", [cpu] { cpu->rra(AddressMode::Indirect_X); }}},
        {0x73, {0x73, 2, 8, "RRA", [cpu] { cpu->rra(AddressMode::Indirect_Y); }}},
    };
}
